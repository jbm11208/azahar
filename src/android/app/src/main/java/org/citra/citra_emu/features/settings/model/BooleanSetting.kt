...
enum class BooleanSetting(
    ...
    DETERMINISTIC_ASYNC_OPERATIONS("deterministic_async_operations", Settings.SECTION_DEBUG, false),    REQUIRED_ONLINE_LLE_MODULES("enable_required_online_lle_modules", Settings.SECTION_SYSTEM, false),    // Performance settings
    PERFORMANCE_AUTO_ADJUST("performance_auto_adjust", Settings.SECTION_PERFORMANCE, true),
    PERFORMANCE_BATTERY_OPTIMIZATION("performance_battery_optimization", Settings.SECTION_PERFORMANCE, true),
    PERFORMANCE_THERMAL_MANAGEMENT("performance_thermal_management", Settings.SECTION_PERFORMANCE, true),

    // Shader cache settings
    SHADER_CACHE_ENABLED("shader_cache_enabled", Settings.SECTION_PERFORMANCE, true),
    SHADER_CACHE_AGGRESSIVE("shader_cache_aggressive", Settings.SECTION_PERFORMANCE, false),
    SHADER_CACHE_CONSERVATIVE("shader_cache_conservative", Settings.SECTION_PERFORMANCE, false);
